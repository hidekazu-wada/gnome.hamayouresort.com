...
const notes = [
  ...
  ["ホテルでは日帰り入浴を行っておりません。"],
  // ※ なっぷのチェックイン受付は 13:00〜16:00 なのに、この注意事項は15時が期限になっている。
  //    両立する運用なのか、どちらかが古いのか要確認（現場ヒアリング項目）
  [
...
// 分ける前は全8種で1つの配列を共有しており、ゲルにも 13:00〜15:00 が出ていた。
//
...
const specSite = [
  ...
  { label: "チェックイン", lines: ["13:00〜16:00　※アーリーチェックインは当日受付のみ可能"] },
...
const specCabin = [
  ...
  { label: "チェックイン", lines: ["14:00〜　※アーリーチェックインは当日受付のみ可能"] },
